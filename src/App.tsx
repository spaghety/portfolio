      ...
      <footer className="footer footer-center p-10 bg-zinc-950 text-base-content rounded"> {/* FOOTER */}
        <nav>
          <div className="grid grid-flow-col gap-4 text-xl">
            <a href="https://linkedin.com/in/phillip-a-jordan" target="_blank" rel="noreferrer"><i className="fa fa-linkedin"></i></a>
            <a href="https://github.com/spaghety" target="_blank" rel="noreferrer"><i className="fa fa-github"></i></a>
            <a href="/resume.pdf" target="_blank" rel="noreferrer"><i className="fa fa-file"></i></a>
          </div>
