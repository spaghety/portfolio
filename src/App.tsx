...
function App() {
  ...
  return (
    <div className="App bg-zinc-900 text-neutral-200">
      ...
      <div className="navbar-center bg-zinc-950 text-xs p-2">
        <ul className="menu menu-horizontal p-0 border-solid border-2 rounded-full border-sky-400 p-0 bg-zinc-900">
          <li><a href="" className="rounded-full p-3 active px-8">Home</a></li>
          <li><a href="" className="rounded-full p-3 px-8">Skills</a></li>
          <li><a href="" className="rounded-full p-3 px-8">Projects</a></li>
        </ul>
      </div>
